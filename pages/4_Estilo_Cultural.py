...
estabilidad_cambio_slider_val = st.slider('', 0, 100, 50, step=10, label_visibility='collapsed', key='estabilidad_cambio_slider')
...
independencia_interdep_slider_val = st.slider('', 0, 100, 50, step=10, label_visibility='collapsed', key='independencia_interdep_slider')

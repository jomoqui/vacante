...
reto_puesto_slider_val = st.slider('', 0, 100, 50, step=5, label_visibility='collapsed', key='reto_puesto_slider')
...
habilidad_puesto_slider_val = st.slider('', 0, 100, 50, step=5, label_visibility='collapsed', key='habilidad_puesto_slider')

...
estabilidad_slider_val = st.slider('', 0, 100, 50, step=25, label_visibility='collapsed', key='estabilidad_slider')
...
ambicion_slider_val = st.slider('', 0, 100, 50, step=25, label_visibility='collapsed', key='ambicion_slider')

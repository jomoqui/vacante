...
permiso_autonomia_slider_val = st.slider('', 0, 100, 50, step=25, label_visibility='collapsed', key='permiso_autonomia_slider')
...
consideracion_respecto_slider_val = st.slider('', 0, 100, 50, step=25, label_visibility='collapsed', key='consideracion_respecto_slider')
